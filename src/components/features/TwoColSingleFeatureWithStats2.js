...
import StatsIllustrationSrc from "images/achievement.png";
...
const Key = tw.div`font-medium text-red-500`;
// StatsIllustrationSrc = tw.div`object-contain`;
const LargeTextSpan = styled.span`
  font-size: 1.3em;
`;
...
export default ({
  subheading = "Our Archievements",
  heading = (
    <>
      We have been in <wbr />
      <LargeTextSpan>
        <span tw="text-teal-500">top 50.</span>
      </LargeTextSpan>
    </>
  ),
