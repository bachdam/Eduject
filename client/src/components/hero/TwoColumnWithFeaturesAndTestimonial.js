...
const Heading = tw(
  SectionHeading
)`text-left text-teal-500 leading-snug xl:text-6xl`;
const Description = tw(
  SectionDescription
)`mt-4 lg:text-base text-gray-700 max-w-lg`;
const PrimaryButton = tw(
  PrimaryButtonBase
)`mt-8 inline-block w-56 tracking-wide text-center py-5 bg-blue-600 hocus:bg-teal-800`;
const FeatureList = tw.ul`mt-12 leading-loose`;
const Feature = tw.li`flex items-center`;
const FeatureIcon = tw(CheckboxIcon)`w-5 h-5 text-yellow-600`;
...
`;
const Testimonial = tw.div`max-w-sm rounded-b md:rounded-none relative sm:absolute bottom-0 inset-x-0 z-20 px-8 py-6 sm:px-10 sm:py-8 bg-teal-800 text-gray-400 font-medium transform md:-translate-x-32 text-sm leading-relaxed md:-mr-16 xl:mr-0`;
...
export default ({
  heading = "Let's level up your careers!",
  ...
  buttonRounded = true,
  features = [
    ">4 Years experience professors",
    "Study anywhere, anytime",
    "99.99% Positive feedback",
  ],
  testimonial = {
    quote:
      "I chose Eduject and couldn't be happier with my decision. With Eduject's help, I achieved my dream career. If I can do it, so can you!",
